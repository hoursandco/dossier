  ...
  return NextResponse.json(
    {
      ...
      // Global filters (added in migration 029). Both null/
      ...
      // Opt-ins for the bottom-of-email compact lists (migration 031).
      // All default false so the API stays back-compat with existing
      // subscribers — they just see the no-extras email.
